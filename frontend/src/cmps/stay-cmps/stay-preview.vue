<template>
    <section class="stay-preview clickable" @click="goToStay">
        <div class="stay-preview-slideshow">
            ...
            <div class="like-stay">
                <span class="material-icons" :class="{ active: isLiked }" @click.stop="toggleWishList">favorite</span>
            </div>
        </div>
        <div class="stay-preview-info">
            <div class="reviews-preview">
                ...
                <span class="review-avg">{{ this.reviewsRateAvg }}&nbsp;</span><span class="reviews-total">({{ this.stay.reviews.length }} reviews)</span>
            </div>
            <div class="property-type">{{ this.stay.propertyType }} • {{ this.stay.loc.city }}</div>
