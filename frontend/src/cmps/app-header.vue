<template>
    ...
    >
        <div class="notify-modal alert" :class="{ showNotes: notify }" @click="killModal">
        ...
        <section class="main-header-container flex space-between">
            ...
            <button @click="miniFilter = !miniFilter" class="mini-filter flex space-between align-center clickable" :class="{ hide: !miniFilter, hideFilter }">{{ currDest }} <span></span></button>
            <div class="nav flex align-center justify-center">
                <router-link to="/explore">Explore</router-link>
                <router-link to="/host">Become a Host</router-link>
                <div class="notifications-container">
                    <span class="material-icons notification-btn" @click="this.openNotifications"> notifications </span>
                </div>
                <div class="main-screen" v-if="this.isNotificationsModal" @click="this.openNotifications"></div>

                <section class="notifications-modal-container" v-if="this.isNotificationsModal">
                    <div class="notifications-modal">
                        <div class="header-notifi">Notifications</div>
                        <div class="notifications-cards flex gray-box-shadow align-center" v-for="(notification, idx) in notifications" :key="idx">
    ...
    watch: {
        "$store.state.currPage": {
            handler() {
                ...
                this.miniFilter = this.currPage !== "homePage" && this.currPage !== "explore";
