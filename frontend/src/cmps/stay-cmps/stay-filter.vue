<template>
    <section class="filter-container flex align-center justify-center">
        <form @submit.prevent="updateTrip" class="max-filter flex space-between align-center">
            <div class="input-container first-container" @click="shouldShow = false">
                <label>
                    Location
                    <input v-model="trip.destination" type="search" list="destination" class="dropdown" placeholder="Where are you going?" />
            ...
            <div class="input-container flex column" @click="shouldShow = !shouldShow">
                <label>
                    Guests
        ...
        <!-- <div class="mobile-filter-container" v-if="showMobileNav">
            <input v-model="trip.destination" type="search" list="destination" class="dropdown" placeholder="Where are you going?" @click="goExplore" />
            <datalist id="destination">
                <option value="Tel Aviv"></option>
                <option value="Barcelona"></option>
                <option value="Paris"></option>
            ...
            <button class="gray-box-shadow clickable" @click="goExplore">
                <h3>I'm flexible</h3>
            </button>
        </div> -->
    </section>
...
export default {
    ...
    methods: {
        goExplore() {
            this.updateTrip();
            this.$router.push(`/explore?destination=${this.trip.destination}`).catch(() => {});
        },
